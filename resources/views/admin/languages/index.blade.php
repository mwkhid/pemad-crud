        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg table-responsive">
                <div class="p-6 text-gray-900">
                    <h1 class="h3 mb-0 text-gray-800 text-center">Tabel Bahasa</h1>
                    <a href="{{ route('languages.create') }}" class="btn btn-info btn-sm mt-1"> Tambah Bahasa</a>
                        ...
                        <tbody>
                            @forelse ($items as $item)
                                <tr>
                                    ...
                                    <td class="align-baseline">{{ $item->bahasa }}</td>
                                    <td class="align-baseline text-center">
                                        <a href="{{ route('languages.edit', $item->id) }}" class="btn btn-warning btn-sm"
                                            data-bs-toggle="tooltip" title="Edit">
                                            Edit
                                        </a>
                                        <form action="{{ route('languages.destroy', $item->id) }}" class="d-inline"
