        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg table-responsive">
                <div class="p-6 text-gray-900">
                    <h1 class="h3 mb-0 text-gray-800 text-center">Tabel Tipe Pekerjaan</h1>
                    <a href="{{ route('types.create') }}" class="btn btn-info btn-sm mt-1"> Tambah Tipe Pekerjaan</a>
                            ...
                            @forelse ($items as $item)
                                <tr>
                                    ...
                                    <td class="align-baseline text-center">
                                        <a href="{{ route('types.edit', $item->id) }}" class="btn btn-warning btn-sm"
                                            data-bs-toggle="tooltip" title="Edit">
                                            Edit
                                        </a>
                                        <form action="{{ route('types.destroy', $item->id) }}" class="d-inline"
